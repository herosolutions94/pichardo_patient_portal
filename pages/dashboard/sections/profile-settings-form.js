...
import { updateProfileSettings, uploadProfileDp } from "@/components/redux/reducers/user";
    ...
    <>
      <form onSubmit={handleSubmit(handleUpdateProfile)}>
        ...
        <div className="flex">
            ...
            <div className="form_blk">
                <IdentificationAttachment identificationPhoto = {identificationPhoto} setIdentificationPhoto={setIdentificationPhoto} isImageLoading={isImageLoading} setIsImageLoading={setIsImageLoading}/>
            </div>
